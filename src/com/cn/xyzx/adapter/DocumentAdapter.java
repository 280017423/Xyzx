...
public class DocumentAdapter extends BaseAdapter {
	...
	private List<DocumentModel> mProductList;
	private ImageLoader mImageDownloader;
	private Builder mOptions;
	private int mWidth;

	public DocumentAdapter(Activity context, List<DocumentModel> list, ImageLoader loader) {
		mContext = context;
		mProductList = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		DocumentModel productModel = mProductList.get(position);
