...
public class ResponsibilityAdapter extends BaseAdapter {
	...
	private List<ResponsibilityModel> mProductList;
	private ImageLoader mImageDownloader;
	private Builder mOptions;

	public ResponsibilityAdapter(Activity context, List<ResponsibilityModel> list, ImageLoader loader) {
		mContext = context;
		mProductList = list;
	...
	@Override
	public ResponsibilityModel getItem(int position) {
		if (null != mProductList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ResponsibilityModel productModel = mProductList.get(position);
